...
export enum MerchantApplicationType {
  STANDARD = 'STANDARD',
}
...
export enum MerchantCallbackType {
...
export enum MerchantCallbackResult {
  PENDING = 'PENDING',
  DELIVERED = 'DELIVERED',
  FAILED = 'FAILED',
  DISABLED = 'DISABLED',
...
export enum RuleOperatorCombiner {
  ANY = 'ANY',
  ALL = 'ALL',
}
...
export enum FinancialAccountNameType {
...
export enum FinancialAccountIdType {
  IBAN = 'IBAN',
...
export enum FinancialInstitutionCodeType {
  BIC = 'BIC',
...
export enum PayinDestinationAccountPoolStatus {
  UNASSIGNED = 'UNASSIGNED',
  PENDING = 'PENDING',
  ASSIGNED = 'ASSIGNED',
  DISABLED = 'DISABLED',
...
export enum PayinDestinationGroupStatus {
  PENDING = 'PENDING',
  ACTIVE = 'ACTIVE',
  DISABLED = 'DISABLED',
  CLOSED = 'CLOSED',
...
export enum PayinDestinationStatus {
  PENDING = 'PENDING',
  ACTIVE = 'ACTIVE',
  DISABLED = 'DISABLED',
  CLOSED = 'CLOSED',
...
export enum PayinDestinationAccountStatus {
  PENDING = 'PENDING',
  ACTIVE = 'ACTIVE',
  DECLINED = 'DECLINED',
  DISABLED = 'DISABLED',
...
export enum PayoutDestinationAccountStatus {
  PENDING = 'PENDING',
  ACTIVE = 'ACTIVE',
  DISABLED = 'DISABLED',
  CLOSED = 'CLOSED',
...
export enum AutoFixWebhookStrategy {
...
export enum MerchantAddonStatus {
  ACTIVE = 'ACTIVE',
  CANCELED = 'CANCELED',
  SUSPENDED = 'SUSPENDED',
}
...
export enum MerchantProfileContactRole {
  FINANCE = 'FINANCE',
  LEGAL = 'LEGAL',
  TECH = 'TECH',
  SUPPORT = 'SUPPORT',
...
export enum MerchantInvoiceLineKind {
  BASE_FEE = 'BASE_FEE',
...
export enum MerchantApplicationDomainPurpose {
  DASHBOARD = 'DASHBOARD',
  CHECKOUT = 'CHECKOUT',
  WEBHOOK = 'WEBHOOK',
  PAY_ID = 'PAY_ID',
...
export enum LicensePeriodStatus {
  OPEN = 'OPEN',
  INVOICED = 'INVOICED',
  DUE = 'DUE',
  PAID = 'PAID',
...
export enum LicensePeriodReason {
  SANDBOX = 'SANDBOX',
  TRIAL = 'TRIAL',
  RENEWAL = 'RENEWAL',
  UPGRADE = 'UPGRADE',
...
export enum LicenseBillingStatus {
  OK = 'OK',
  DUE_SOON = 'DUE_SOON',
  DUE = 'DUE',
  OVERDUE = 'OVERDUE',
...
export enum EmailCorrelationType {
  TRANSACTION = 'TRANSACTION',
  USER = 'USER',
  MERCHANT = 'MERCHANT',
  KYC = 'KYC',
